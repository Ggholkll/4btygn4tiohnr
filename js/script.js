...
window.addEventListener('scroll' , functionResize)
 ...
 function functionResize(e) {
  ...
  if (Width <= 1280) {
     ...
     functionehead( elementItemMenu.after(elementLogo)  , headerContent.append(elementContact), elementContact.classList.add('top-header__columns') )   
      : 
      functionehead( headerContent.prepend(elementLogo) , elementToheaderColumnsMenus.append(elementContact) ,  elementContact.classList.remove('top-header__columns')  )
